...
const prices = [
  ...
  1400, 1420, 1440, 1460, 1480, 1500, 1495, 1490, 1485, 1480,
  1475, 1470, 1465
];
    ...
    >
      <defs>
        ...
        <linearGradient id={`${id}-gradient`} x1="0" x2="0" y1="0" y2="1">
          <stop offset="0%" stopColor="#015d4b" />
          <stop offset="100%" stopColor="#015d4b" stopOpacity="0" />
        </linearGradient>
      </defs>
      ...
      <motion.path
        ...
        {...(isInView ? { stroke: '#01735c', animate: { pathLength: 1 } } : {})}
        onUpdate={({ pathLength }) => {
      ...
      <AppScreen.Body>
        <div className="p-4">
          <div className="flex gap-2">
            <div className="text-xs/6 text-gray-500">Putting People to Sleep, Inc.</div>
          ...
          <div className="mt-3 border-t border-gray-200 pt-5">
              ...
              {percentageChange && (
                <div
                  className={clsx(
                    ...
                    percentageChange >= 0 ? 'text-pine-green-500' : 'text-gray-500',
                  )}
                >
                  {`${
                    percentageChange >= 0 ? '+' : ''
            ...
            <div className="mt-6 flex gap-4 text-xs text-gray-500">
              <div>1D</div>
              <div>5D</div>
              <div className="font-semibold text-pine-green-600">1M</div>
              <div>6M</div>
              <div>1Y</div>
              <div>5Y</div>
            </div>
            ...
            <div className="mt-4 rounded-lg bg-pine-green-500 px-4 py-2 text-center text-sm font-semibold text-white">
              Trade
            </div>
